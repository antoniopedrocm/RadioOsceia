...
export const programs: Program[] = [
  ...
  { id: '2', titulo: 'Estudo do Evangelho', categoria: 'Estudo', apresentador: 'Carlos Mendes', duracao: '60 min', origem: 'Vídeo local', instituicao: 'Irmão Áureo', descricao: 'Estudo estruturado com participação da comunidade.', capa: 'https://images.unsplash.com/photo-1469474968028-56623f02e42e?q=80&w=400' },
